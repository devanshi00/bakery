    ...
    <div className="bakery-homepage">
      ...
      <header className="hero" style={{ backgroundImage: `url(${heroImages[currentHeroImage]})` }}>
        <div className="hero-content">
          ...
          <p>Home Cook👩🏻‍🍳 and Baker🍰 - Where Love Meets Flavor!</p>
      ...
      <section className="about" style={{ backgroundColor: "#f9f9f9", padding: "40px 0" }}>
        <div className="container">
          <h2>About Us</h2>
          <p>
            Welcome to Kiran's Kitchen! I'm a passionate home cook and baker specializing in delicious cakes, brownies, cheesecakes, and gourmet delicacies. Based in Gondal and Rajkot, I create customized cakes, muffins, brownies, and dessert jars made with love and the finest ingredients. Every creation is crafted to make your special moments even more memorable!
          </p>
      ...
      <section className="video-section" style={{ padding: "40px 0", backgroundColor: "#f0f0f0" }}>
        <div className="container">
          <h2>Behind the Scenes at Kiran's Kitchen</h2>
          <p>Take a peek into my home kitchen where every dessert is crafted with love, care, and attention to detail!</p>
...
loop // Key prop forces the video to restart on each change
      ...
      <section className="menu-highlights" style={{ backgroundColor: "#fff", padding: "40px 0" }}>
        <div className="container">
          ...
          <p>Discover my signature creations — from elegant engagement cakes to decadent dessert jars, all made fresh to order.</p>
